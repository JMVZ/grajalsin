...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Grajalsin</title>

        <!-- Favicon -->
        <link rel="icon" type="image/png" href="{{ asset('favicon.ico') }}">
        <link rel="apple-touch-icon" href="{{ asset('grajalsin-removebg-preview.png') }}">
    ...
    <body class="font-sans antialiased bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div class="min-h-screen flex" x-data="{ mobileMenuOpen: false }">
            ...
            <div x-show="mobileMenuOpen"
                 ...
                 class="fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-b from-white to-gray-50 border-r border-gray-200 shadow-xl md:hidden overflow-y-auto">
                <div class="flex flex-col flex-grow pt-6">
                    <!-- Logo Mobile -->
                    <div class="flex items-center flex-shrink-0 px-6 mb-8">
                        <a href="{{ route('dashboard') }}" class="flex items-center w-full" @click="mobileMenuOpen = false">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('grajalsin-removebg-preview.png') }}" alt="Grajalsin Logo" class="h-12 w-auto">
                            </div>
                            <div class="ml-4 flex-1">
                                <h1 class="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Grajalsin</h1>
                                <p class="text-xs text-gray-500 font-medium">Control de Granos</p>
                        ...
                        <button @click="mobileMenuOpen = false" class="ml-auto text-gray-500 hover:text-gray-700">
            ...
            <div class="flex flex-col w-0 flex-1 overflow-hidden">
                <!-- Top navigation -->
                <div class="relative z-10 flex-shrink-0 flex h-16 sm:h-20 bg-white/80 backdrop-blur-lg border-b border-gray-200 shadow-sm">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="px-4 border-r border-gray-200 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500 md:hidden transition-colors">
                        <span class="sr-only">Abrir menú</span>
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                        </svg>
                    </button>
                    <div class="flex-1 px-4 sm:px-6 flex justify-between sm:justify-end items-center">
                        <!-- Logo móvil -->
                        <div class="flex items-center md:hidden">
                            <img src="{{ asset('grajalsin-removebg-preview.png') }}" alt="Grajalsin" class="h-8 w-auto">
                            <span class="ml-2 text-lg font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Grajalsin</span>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                <div class="flex items-center space-x-2 sm:space-x-4">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
