    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-green-600 mt-1">Documenta una pérdida o merma de inventario</p>
            </div>
    ...
    <div class="space-y-6">
        <div class="bg-white shadow rounded-lg border border-green-200">
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('inventario.perdidas.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="tipo_perdida" id="tipo_perdida" value="{{ old('tipo_perdida') }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="valor_estimado" id="valor_estimado" step="0.01" value="{{ old('valor_estimado') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                placeholder="Describe cómo ocurrió la pérdida...">{{ old('descripcion') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="acciones_tomadas" id="acciones_tomadas" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                placeholder="¿Qué se hizo al respecto? Ej: Se fumigó la bodega, se reparó el techo...">{{ old('acciones_tomadas') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Opcional: Toma una foto como evidencia</p>
                        </div>
                    </div>
