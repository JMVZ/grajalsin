    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Modifica la información del usuario y sus permisos</p>
            </div>
            <div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mt-4">
                            <div class="flex">
                                ...
                                <p class="text-sm text-blue-700">
                                    <strong>Nota:</strong> Para asignar módulos específicos a este usuario (si no es administrador), usa la opción "Gestionar Módulos" en la lista de usuarios.
                                </p>
                            </div>
                        </div>
                    </div>
